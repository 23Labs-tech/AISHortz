...
//             <img src="logo.png" alt="AIShortz" className="w-25 h-25 object-contain" />
//             {/* <span className="text-2xl font-bold text-white">AIShortz</span> */}
//           </div>
...
//             {[0,1,2,3,4,5].map(i => (
//               <div key={i} className="w-16 h-16 rounded-full border-4 border-black bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center text-white font-bold text-xl shadow-xl">
//                 {i === 5 ? '+99' : String.fromCharCode(65 + i)}
//               </div>
//             ))}
//           </div>
  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center px-6 py-12">
      <div className="w-full max-w-7xl grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
        ...
        <div className="max-w-md mx-auto w-full">
          <div className="flex items-center gap-3 mb-12">
            <img src="/logo.png" alt="AIShortz" className="h-12 object-contain" />
          </div>
